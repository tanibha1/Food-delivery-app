  ...
  return (
   ...
   <View style={{ padding: 10, flexDirection: "row", alignItems: "center" }}>
      ...
      <View
        ...
        <Text style={{fontSize:16, fontWeight: "500"}} >Ordering for Someone else ?</Text>
        <Text style ={{fontSize:16,fontWeight:"700", color: "#FF4500"}}>Add Details</Text>
      </View>
      ...
      <View style ={{padding:10}}>
        ...
        <ScrollView horizontal style={{marginTop :10}} showsHorizontalScrollIndicator={false}>
          {instructions.map((item,i) => (
            <Pressable style= {{margin:10, borderRadius:10,padding:10, backgroundColor: "white"}}>
           <View>
            <FontAwesome5 name={item.iconName} 
            size={22}
             color="grey"/>
             <Text style={{
              width:75,
